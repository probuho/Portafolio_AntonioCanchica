...
export default function Roadmap() {
    const milestones = [
        ...
        },
        {
            year: '2019',
            icon: FaGraduationCap,
            title: 'Inicio en UNETI',
            description: 'Comenzó estudios en PNF. Ingeniería en Informática',
            type: 'education',
            color: 'cyber-cyan',
        },
        {
            ...
            description: 'Aprendizaje de HTML, CSS, JavaScript. Certificaciones en Community Manager y Social Media',
            type: 'transition',
            color: 'cyber-neon',
        },
        {
        ...
        },
        {
            ...
            description: 'Aplicación de IA generativa en desarrollo. Búsqueda activa de oportunidades profesionales',
            type: 'current',
            color: 'cyber-neon',
        },
    ];
