...
import { FaTimes, FaCertificate, FaCheckCircle, FaEye } from 'react-icons/fa';
    ...
    const certifications: Certification[] = [
        {
            ...
            verified: true,
            certificatePath: '/certificates/social-media-manager.jpg',
        },
        {
            ...
            verified: true,
            certificatePath: '/certificates/community-manager-online.jpg',
        },
        {
